...
Here is an example of how commands, functions and operators are
...
direct mode, whereas the second one wasn't. {\bf PRINT} works in both direct and indirect mode.
...
whereas string variables are initialised as an empty string \screentext{""}.
