...
that you provide as part of the command or function call, to help describe what you want to achieve.
Some also require that you use special keywords.
Here is an example of how commands, functions, and operators (all of which are also known as keywords) are
described in this appendix:

{\bf KEY <numeric expression>,<string expression> }

In this case, KEY is a \textbf{keyword}. That means it's
...
an optional numeric argument to indicate whether the circle should be filled
whilst being drawn.

The comma, and some other symbols and punctuation marks simply represent themselves.
...
syntax error, and the MEGA65 will tell you if you have made one
by displaying a \screentext{?SYNTAX ERROR} message.
...
more {\bf``expressions''}.
An expression is just a fancy name for something that equates to a value.
...
If you accidentally use the wrong type, the computer will display a
...
\begin{center}
    ...
    \begin{longtable}{c|L{8cm}}
        ...
        at least one expression. You must enter all commas up to the left of the last expression
        you're leaving in. \\
        \hline
        [\{ , \}] &
...
Constants are values that can't be changed by your program while it is running. BASIC 65 has four types of constants,
